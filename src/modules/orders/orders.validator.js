...
const validateOrdersBoardFilters = validateMiddleware(
	ordersBoardFilterSchema,
	"query",
);
const validateAddOrderItem = validateMiddleware(addOrderItemSchema, "body");
const validateUpdateOrderItem = validateMiddleware(
	updateOrderItemSchema,
	"body",
);
const validateUpdateOrderItemPreparationStatus = validateMiddleware(
	updateOrderItemPreparationStatusSchema,
	"body",
);
...
const validateOrderItemIdParam = validateMiddleware(
	orderItemIdParamSchema,
	"params",
);
module.exports = {
