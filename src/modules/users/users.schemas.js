...
const {
	idParamSchema,
	paginationSchema,
} = require("../../common/validators/common.schemas");
...
const createUserSchema = Joi.object({
	...
	role_name: Joi.string().valid(ROLES.ADMIN, ROLES.CASHIER).required(),
});
...
const updateUserSchema = Joi.object({
	...
	role_name: Joi.string().valid(ROLES.ADMIN, ROLES.CASHIER).optional(),
}).min(1);
