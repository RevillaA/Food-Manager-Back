...
const validateUpdateSalePaymentStatus = validateMiddleware(
	updateSalePaymentStatusSchema,
	"body",
);
const validateSalesFilters = validateMiddleware(salesFilterSchema, "query");
const validateSalesDayFilters = validateMiddleware(
	salesDayFilterSchema,
	"query",
);
const validateSalesRangeFilters = validateMiddleware(
	salesRangeFilterSchema,
	"query",
);
