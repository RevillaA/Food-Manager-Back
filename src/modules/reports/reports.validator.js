...
const validateSalesDayReport = validateMiddleware(
	salesDayReportSchema,
	"query",
);
const validateSalesRangeReport = validateMiddleware(
	salesRangeReportSchema,
	"query",
);
const validateTopProductsReport = validateMiddleware(
	topProductsReportSchema,
	"query",
);
const validateCategorySummaryReport = validateMiddleware(
	categorySummaryReportSchema,
	"query",
);
